...
public interface ServicioConsumoRepo extends JpaRepository<ServicioConsumo, Integer> {
     ...
     void actualizarServicioConsumo(@Param("id") long id, @Param("descripcion") String descripcion,
               ...
               @Param("fecha") Date fecha, @Param("idhabitacion") Integer idhabitacion,
     ...
     Collection<RespuestaServicioConsumoPorCliente> darServicioConsumoPorCliente(@Param("idusuario") long idusuario,
